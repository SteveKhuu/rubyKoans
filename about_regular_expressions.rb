...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # They're greedy because they match in regexp's match in sequential order
  # The rest of a regexp pattern cannot be satisfied unless all the parts before it are satisfied
  # ------------------------------------------------------------------
