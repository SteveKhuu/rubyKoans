...
class AboutSymbols < Neo::Koan
  ...
  # Converting a symbol into a string ensures that the symbol already exists.
  # Checking to see if a symbol exists will inadvertently create a symbol
  ...
  # You may override/take over the name of a function, wasted memory
end
